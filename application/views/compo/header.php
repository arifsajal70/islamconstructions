                        ...
                        <div class="a-grid">
                            <div class="row row-sm">
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="<?php echo base_url('assets/');?>img/brands/dropbox.png" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="<?php echo base_url('assets/');?>img/brands/github.png" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="<?php echo base_url('assets/');?>img/brands/wordpress.png" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="<?php echo base_url('assets/');?>img/brands/gmail.png" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="<?php echo base_url('assets/');?>img/brands/drive.png" alt=""></div>
                                ...
                                <div class="col-xs-4">
                                    <div class="a-item">
                                        <a href="#">
                                            <div class="ai-icon"><img class="img-fluid" src="<?php echo base_url('assets/');?>img/brands/dribbble.png" alt=""></div>
