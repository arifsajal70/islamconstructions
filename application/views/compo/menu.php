<div class="site-sidebar">
    <div class="custom-scroll custom-scroll-light">
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?php echo base_url('engineers');?>" class="waves-effect waves-light">
                    <span class="s-icon"><i class="ti-user"></i></span>
                    <span class="s-text">Engineers</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('managers');?>" class="waves-effect waves-light">
                    <span class="s-icon"><i class="ti-face-smile"></i></span>
                    <span class="s-text">Manager</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('employees');?>" class="waves-effect waves-light">
                    <span class="s-icon"><i class="ti-face-smile"></i></span>
                    <span class="s-text">Employees</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('sites');?>" class="waves-effect waves-light">
                    <span class="s-icon"><i class="ti-face-smile"></i></span>
                    <span class="s-text">Sites</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url('items');?>" class="waves-effect  waves-light">
